      ...
      body: Padding(
        padding: const EdgeInsets.only(left:15, right: 15, top: 5, bottom: 2),      child: Column(
          ...
          child: const Padding(
            ...
            const Text("Usable 0", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 20),),


            const LabelWithAsterisk(labelText: 'Wallet' , isRequired: true, color: Colors.white,),
            ...
            const LabelWithAsterisk(labelText: 'Amount' , isRequired: true, color: Colors.white,),
            ...
            const LabelWithAsterisk(labelText: 'Charge 0%' , isRequired: true, color: Colors.white,),
